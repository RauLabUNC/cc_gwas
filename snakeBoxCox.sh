...
#SBATCH --time=02:00:00   # Reduced time, adjust as needed for R script
...
snakemake --snakefile Snakefile_boxCox \
          -j 250 \
          --latency-wait 60 \
          --cluster "sbatch --time 01:00:00 --mem=4000 -N 1 -n 1 -o .slurmlogs/norm_job_%j.out" `# Cluster settings for individual R script jobs` \
          --keep-going \
          --rerun-incomplete 